...
export class NavbarUserComponent implements OnInit {
  ...
  toggleMateriasMenu(): void {
    this.materiasMenuOpen = !this.materiasMenuOpen;
  }

  navigateToRegistroMaterias(): void {
    console.log('Navegando a registro de materias...');
    this.materiasMenuOpen = false; // Cerrar el dropdown
    this.router.navigate(['/registro-materias']).then(
      (success) => {
  ...
  navigateToListaMaterias(): void {
  console.log('Navegando a lista de materias...');
  this.materiasMenuOpen = false;
  // Usa la ruta exacta como está en app-routing.module.ts
  this.router.navigate(['/lista-materias']).then( // <-- Con slash inicial
    (success) => {
      console.log('Navegación exitosa:', success);
    },
    (error) => {
