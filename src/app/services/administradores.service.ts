...
export class AdministradoresService {
  ...
  // Método para obtener lista de admins con paginación
  public obtenerListaAdmins(params?: any): Observable<any> {
    const token = this.facadeService.getSessionToken();
    let headers: HttpHeaders;
    if (token) {
      headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + token });
    ...
    return this.http.get<any>(`${environment.url_api}/lista-admins/`, { headers, params: httpParams });
  }
